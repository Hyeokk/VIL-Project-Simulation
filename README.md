...
### 3. Additional Worlds
- Added `project.sdf` and `project_baseline.sdf` worlds, contributed by graduate intern [Kang Soon-hyuk GitHub](https://github.com/Kangsoonhyuk/FASTLIO-Offroad-Sim.git).
