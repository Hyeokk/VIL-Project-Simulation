            ...
            [
                {
                    'use_sim_time': True
                    ,
                    'config_file': '/home/vil/clearpath_ws/src/clearpath_simulator/clearpath/sensors/config/camera_0.yaml'
                    ,
                }
                ,
            ]
        ...
        remappings=
            [
                ...
                (
                    ...
                    ,
                    '/sensors/camera_0/depth/compressed'
                )
                ,
                (
